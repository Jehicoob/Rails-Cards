...
ActiveRecord::Schema.define(version: 2022_11_11_174339) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["user_id", "deck_id"], name: "index_favorites_on_user_id_and_deck_id", unique: true
